...
DownloadingLabel2=Đang tải các tệp bổ sung...
...
ErrorDownloading=Đã xảy ra lỗi khi tải tệp: %1
ErrorExtracting=Đã xảy ra lỗi khi giải nén: %1
ErrorExtractionAborted=Quá trình giải nén đã bị hủy bỏ.
ErrorExtractionFailed=Giải nén thất bại: %1
ArchiveIncorrectPassword=Mật khẩu tệp lưu trữ không chính xác.
ArchiveIsCorrupted=Tệp lưu trữ bị hỏng.
ArchiveUnsupportedFormat=Định dạng tệp lưu trữ không được hỗ trợ.
RetryCancelSelectAction=Chọn thao tác tiếp theo:
RetryCancelRetry=&Thử lại
RetryCancelCancel=Hủ&y
SourceVerificationFailed=Xác minh nguồn tệp thất bại.
...
VerificationSignatureDoesntExist=Chữ ký xác minh không tồn tại.
